...
use Elton\CoreBundle\Entity\Level;
use Elton\CoreBundle\Form\LevelType;
...
class LevelController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('EltonCoreBundle:Level')->findAll();
     ...
     * @Method("POST")
     * @Template("EltonCoreBundle:Level:new.html.twig")
     */
    ...
    */
    ...
    public function newAction()
    {
        ...
        return $this->render('EltonCoreBundle:Level:new.html.twig', array(
        'entity' => $entity,
        'form'   => $form->createView(),
        ));
    }
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('EltonCoreBundle:Level')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("EltonCoreBundle:Level:edit.html.twig")
     */
    public function updateAction(Request $request, $id)
    {
        ...
        if ($editForm->isValid()) {
            ...
            return $this->redirect($this->generateUrl('level_show', array('id' => $id)));
        }
