...
class ResettingController extends Controller
{
    ...
    public function sendEmailAction(Request $request)
    {
        ...
        $returnArray['email'] = $this->getObfuscatedEmail($user);

        return new RedirectResponse($this->container->get('router')->generate('fos_user_resetting_check_email', $returnArray));
    }
